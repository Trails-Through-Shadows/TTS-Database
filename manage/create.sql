...
CREATE TABLE `Effect` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `type` ENUM ('PUSH', 'PULL', 'FORCED_MOVEMENT_RESISTANCE', 'POISON', 'POISON_RESISTANCE', 'FIRE', 'FIRE_RESISTANCE', 'BLEED', 'BLEED_RESISTANCE', 'DISARM', 'DISARM_RESISTANCE', 'ROOT', 'ROOT_RESISTANCE', 'STUN', 'STUN_RESISTANCE', 'CONFUSION', 'CONFUSION_RESISTANCE', 'GUIDANCE', 'INVINCIBILITY', 'SHIELD', 'WEAKNESS', 'WEAKNESS_RESISTANCE', 'HEAL', 'REGENERATION', 'EMPOWER', 'ENFEEBLE', 'ENFEEBLE_RESISTANCE', 'SPEED', 'SLOW', 'SLOW_RESISTANCE', 'REACH', 'CONSTRAIN', 'CONSTRAIN_RESISTANCE', 'INCORPOREAL', 'BONUS_HEALTH', 'BONUS_DEFENCE', 'BONUS_INITIATIVE') NOT NULL,
  `description` TEXT,
  `duration` INT NOT NULL,
  `strength` INT,
  `target` ENUM ('SELF', 'ONE', 'ALL', 'ALL_ENEMIES', 'ALL_ALLIES') NOT NULL,
