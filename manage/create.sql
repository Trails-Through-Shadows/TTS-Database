...
CREATE TABLE `Effect` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `type` ENUM ('PUSH', 'PULL', 'FORCED_MOVEMENT_RESISTANCE', 'POISON', 'POISON_RESISTANCE', 'FIRE', 'FIRE_RESISTANCE', 'BLEED', 'BLEED_RESISTANCE', 'STUN', 'STUN_RESISTANCE', 'CONFUSION', 'CONFUSION_RESISTANCE', 'GUIDANCE', 'PROTECTION', 'VULNERABILITY', 'VULNERABILITY_RESISTANCE', 'HEAL', 'REGENERATION', 'EMPOWER', 'ENFEEBLE', 'ENFEEBLE_RESISTANCE', 'SPEED', 'SLOW', 'SLOW_RESISTANCE') NOT NULL,
  `description` TEXT,
  `duration` INT,
  `strength` INT,
  `target` ENUM ('SELF', 'ONE', 'ALL', 'ALL_ENEMIES', 'ALL_ALLIES') NOT NULL,
